# Generated by Django 2.0.1 on 2018-03-07 05:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept_type', models.CharField(default='Null', max_length=150, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='DiseaseLink',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diseaseLink', models.IntegerField(blank=True, default=0)),
                ('add_at', models.DateTimeField(auto_now_add=True, verbose_name='createdAt')),
                ('user', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='demo.User')),
            ],
        ),
        migrations.CreateModel(
            name='Value',
